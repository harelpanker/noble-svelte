	...
	>
		...
		<div class="flex items-start gap-x-2">
			...
			<Label.Root id="confirm-label" for="confirm" class="text-sm">
				By checking this box, I approve that Noble may contact me, using automated technology, with
				the contact details entered on this form, to share relevant opportunities. I confirm that
				I've read the <a class="underline" href="/">Noble Privacy Policy</a>.
			</Label.Root>
		</div>
		<Button.Root
			type="submit"
